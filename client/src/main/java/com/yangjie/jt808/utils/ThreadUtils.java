package com.yangjie.jt808.utils;
...
public final class ThreadUtils {
     ...
     */
    public static <T> void executeByFixed(final int size, final Task<T> task) {
     ...
     * @param <T>   The type of the task's result.
     */
    public static <T> void executeByFixedWithDelay(final int size,
                                                   final Task<T> task,
                                                   final long delay,
                                                   final TimeUnit unit) {
     ...
     * @param <T>    The type of the task's result.
     */
    public static <T> void executeByFixedAtFixRate(final int size,
                                                   final Task<T> task,
                                                   final long period,
                                                   final TimeUnit unit) {
    ...
    public static void cancel(ExecutorService executorService) {
        if (executorService instanceof ThreadPoolExecutor4Util) {
            ...
            System.out.println("ThreadUtils The executorService is not ThreadUtils's pool.");
        }
    }
    ...
    private static <T> void execute(final ExecutorService pool, final Task<T> task,
        ...
        synchronized (TASK_POOL_MAP) {
            if (TASK_POOL_MAP.get(task) != null) {
                System.out.println("ThreadUtils Task can only be executed once.");
                return;
            }
    ...
    static final class ThreadPoolExecutor4Util extends ThreadPoolExecutor {
        ...
        public void execute(Runnable command) {
            ...
            try {
                ...
                System.out.println("ThreadUtils This will not happen!");
            ...
            Thread t = new Thread(r, namePrefix + getAndIncrement()) {
                ...
                public void run() {
                    try {
                        ...
                        System.out.println("ThreadUtils Request threw uncaught throwable");
                    }
                }
            };
    ...
    public abstract static class SimpleTask<T> extends Task<T> {
        ...
        public void onCancel() {
            System.out.println("ThreadUtils onCancel: ");
        }
            ...
            if (isSchedule) {
                if (runner == null) {
                    ...
                    if (mTimeoutListener != null) {
                        System.out.println("ThreadUtils Scheduled task doesn't support timeout.");
                    }
                } else {
